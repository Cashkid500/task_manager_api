...
// 405 Method Not Allowed
    function respondMethodNotAlowed($maindata, $text, $hint, $linktosolve, $errorcode)
    {
    ...
    function respondInternalError($maindata, $text, $hint, $linktosolve, $errorcode){
        $method = getenv('REQUEST_METHOD');
        $endpoint = Utility_Functions::getCurrentFullURL();

        $errordata = ["code" => $errorcode, "text" => "Error connecting with DB server", "link" => "$linktosolve", "hint" => $hint];
        $data = ["status" => false, "text" => $text, "data" => $maindata, "time" => date("d-m-y H:i:sA", time()), "method" => $method, "endpoint" => $endpoint, "error" => $errordata];
    ...
    function respondExternalError($maindata, $text, $hint, $linktosolve, $errorcode){
        $method = getenv('REQUEST_METHOD');
        $endpoint = Utility_Functions::getCurrentFullURL();

        $errordata = ["code" => $errorcode, "text" => "External service unavailable", "link" => "$linktosolve", "hint" => $hint];
        $data = ["status" => false, "text" => $text, "data" => $maindata, "time" => date("d-m-y H:i:sA", time()), "method" => $method, "endpoint" => $endpoint, "error" => $errordata];
